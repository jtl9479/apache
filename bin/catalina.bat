...
set CATALINA_OPTS=-javaagent:C:\scouter\agent.java_6_7\scouter.agent.jar -Dscouter.config=C:\scouter\agent.java_6_7\conf\pda_in.conf -Dobj_name=PDA_IN
...
:doStart
shift
if "%TITLE%" == "" set TITLE=Tomcat PDA_IN
